...
import { Squares2X2Icon, CalendarDaysIcon, UserIcon, VideoCameraIcon, ArrowLeftStartOnRectangleIcon } from "@heroicons/react/24/solid"
        ...
        <nav className="bg-[#F7F6FE] w-[150px] border border-r-[#DBDAE5] p-4">
            ...
            <div className="flex flex-col gap-[220px] text-base text-[#F66E49]">
                <div className="flex flex-col gap-[35px]">
                    ...
                    <Link to="#" className="flex gap-1">
                        <span><VideoCameraIcon className="w-[20px] h-[20px]" /></span>
                        <span>Meeting</span>
                    </Link>
                </div>
