    ...
    return (
        <div className="bg-[#F7F6FE] w-full border border-l-[#DBDAE5]">
            <div className="px-3 flex flex-col gap-10">
                ...
                {/*Medical History  */}
                <div>
                    <h3 className="text-[#8B7EF8] font-medium text-xl mb-5">My Medical Report</h3>
                    <button className="bg-[#8B7EF8] flex gap-1 text-white py-2 px-3 rounded-[8px]">View Report</button>
                </div>
                {/* Image */}
                <div>
