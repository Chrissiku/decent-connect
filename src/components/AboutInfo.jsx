const AboutInfo = () => {
  ...
  return (
    <div className="md:p-10">
      <div className="flex flex-col items-center justify-between w-full space-y-5 md:space-y-10">
        {aboutCards.map((item, index) => (
          <div
            key={index}
            className="flex flex-col bg-[#FFFFFF01] w-full
           shadow-lg border-l-8 border-shade rounded-lg p-8 space-y-3 hover:bg-light-gray"
          >
